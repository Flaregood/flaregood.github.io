    ...
    addListItem: function (obj, type) {
      ...
      if (type == "exp") {
        ...
        html = '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div>' +
          '<div class="right clearfix">' + '<div class="item__value">%value%</div><div class="item__percentage">%percentage%</div><div class="item__delete">' +
...
var Controller = (function (budgetCtrl, UICtrl) {
  ...
  var ctrlAddItem = function () {
    // TODO: event for confirm button and enter key
    var input, newItem;
    // 1. Get input field
