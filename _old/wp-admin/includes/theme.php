...
function get_theme_update_available( $theme ) {
	...
	if ( isset($themes_update->response[ $stylesheet ]) ) {
		...
		/* modifica */
		$html = apply_filters( 'av_update_theme_link', $html, $theme_name, $update_url, $update['package'] );
		/* fine */
	}
	...
	$features = array(
		...
		__( 'Subject' )  => array(
			...
			'portfolio'      => __( 'Portfolio' ),
				...
				'tech'       		=> __( 'Tech' ),
				'art'       		=> __( 'Art' ),
				'personal-blog'     => __( 'Personal Blog' ),
				'woman'       		=> __( 'Woman' ),
				'minimal'       	=> __( 'Minimal' ),
				'colorful'       	=> __( 'Colorful' ),
				'nature'      		=> __( 'Nature' ),
				'grunge'       		=> __( 'Grunge' )		
		),
		__('Layout') => array(
